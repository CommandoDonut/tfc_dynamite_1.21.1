...
public class BuiltInItemModels extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		getBuilder(ExampleModItems.EXAMPLE_SIMPLE_ITEM).parent(ITEM_GENERATED).texture("layer0", mcLoc("item/barrier"));
		getBuilder(ExampleModItems.EXAMPLE_SIMPLE_ITEM_WITH_CUSTOM_PROPERTIES).parent(ITEM_GENERATED).texture("layer0", mcLoc("item/diamond"));
		getBuilder(ExampleModItems.EXAMPLE_ITEM_WITH_CUSTOM_PROPERTIES).parent(ITEM_GENERATED).texture("layer0", mcLoc("item/empty_slot_redstone_dust"));
	}
