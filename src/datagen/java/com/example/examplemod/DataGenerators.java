...
import com.example.examplemod.providers.models.*;
...
public final class DataGenerators {
	...
	private static void gatherData(final GatherDataEvent event) {
		...
		final var builtInLanguage = generator.addProvider(event.includeClient(), new BuiltInLanguage(packOutput, lookupProvider));
		builtInLanguage.extraLanguage(builtInAdvancements);
